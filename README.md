...
Telegram бот мониторит cian и сообщает о новых объявлениях.
...
Каждый состоит из пары зарегистрированного Telegram-бота и docker контейнера, связанных через токен.
...
Командой `/newbot` задайте адрес бота <https://t.me/..._bot> и получите токен. Сохраните токен в сектере.
